...
abstract class CRM_Ibanaccounts_Buildform_IbanAccounts {
  ...
  public function parse() {
    ...
    CRM_Core_Resources::singleton()->addScriptFile('org.civicoop.ibanaccounts', 'js/iban_account.js', -1, 'page-header');
    CRM_Core_Resources::singleton()->addScriptFile('org.civicoop.ibanaccounts', 'js/'.strtolower($this->getName()).'.js', 10, 'page-header');
  }
